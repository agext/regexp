...
//
//	Find(All)?(String)?(Submatch|Named)?(Index)?
//
...
//
// If 'Named' is present, the return value is a map identifying the
// named submatches of the expression. The value of the key "" (empty string)
// is the match of the entire expression.
//
